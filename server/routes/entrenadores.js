...
module.exports=(app)=>{
    ...
    app.post(`${api.baseEndpoint}/entrenadores/registrar`, validateAuth, authorizeRole([plataforma.roles.admin, plataforma.roles.root]),  controllersEntrenadores.createCoach);
