...
module.exports=(app)=>{
    ...
    app.get(`${api.baseEndpoint}/agenda-actividades/:id`, validateAuth, authorizeRole([plataforma.roles.admin, plataforma.roles.instructor, plataforma.roles.usuario]),controllersAgendaActivities.getAgendaActivity);
